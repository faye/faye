...
JS.ENV.NodeAdapterSpec = JS.Test.describe("NodeAdapter", function() { with(this) {
  ...
  define("origins", function() {
    return null
  })

  define("options", function() {
    return {mount: "/bayeux", origins: this.origins(), timeout: 30}
  })
  ...
  describe("POST requests", function() { with(this) {
    describe("with cross-origin access control", function() { with(this) {
      sharedBehavior("cross-origin request", function() { with(this) {
        define("origins", function() { return ["http://example.com"] })

        describe("with an allowed origin", function() { with(this) {
          before(function() { with(this) {
        ...
        describe("with a blocked origin", function() { with(this) {
          before(function() { with(this) {
            header("Origin", "http://hacker.com")
          }})

          it("does not forward the message param onto the server", function() { with(this) {
            expect(server, "process").exactly(0)
            post("/bayeux", "message=%7B%22channel%22%3A%22%2Fplain%22%7D")
          }})

          it("returns a 403 response", function() { with(this) {
            post("/bayeux", "message=%7B%22channel%22%3A%22%2Fplain%22%7D")
            check_status(403)
          }})
        }})
